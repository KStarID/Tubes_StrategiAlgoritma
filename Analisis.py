...
n = 11      # ukuran matrix yang akan dibuat
...
# Matriks biaya untuk masalah penugasan
cost_matrix = np.random.randint(1, 10, size=(n, n))
print("Matrix dengan ukuran ", n, " x ", n, "yang terbentuk adalah : \n")
print(cost_matrix)
print("\n")

# Menjalankan fungsi assignment_problem
print("Hasil dari fungsi bnb:")
...
# Menjalankan fungsi work
print("Hasil dari fungsi exhaustive:")
start_time = time.time()
b = work(cost_matrix)
end_time = time.time()
print("Waktu eksekusi   :", end_time - start_time, "detik")